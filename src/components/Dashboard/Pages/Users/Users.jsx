...
const Users = ({ width }) => {
    ...
    const handleUsers = (e,page) => {
        ...
        if(nameState){
            urlencoded.append('name', nameState);
        }
        if(levelState){
        ...
        fetch('https://secure.platinumpay.cc/v1/client/users/getUsers', {
            ...
            .then(data => {
                ...
                if(data.response.count){
                    ...
                    showMess('Пользователи не найдены')
                }
                setLoading(false);
            })
            .catch(err => {
    ...
    return (
        <>
            ...
            >
                ...
                >
                {data.arr.length > 0 ?
                     <UsersTable data={data} setData={setData} setLoading={setLoading} nameState={nameState} setNameState={setNameState} levelState={levelState} setLevelState={setLevelState} page={pageState} handleUsers={handleUsers}/>
                    : 
                    null}
                </Box>
